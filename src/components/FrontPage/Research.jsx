    ...
    return (
        <div>
            ...
            <div className='grid md:grid-cols-3 gap-3 py-10'>
                {
                    research.map(res => <div key={res} className="bg-white shadow-lg rounded-lg overflow-hidden p-5 flex flex-col">
                        ...
                        <div className='flex justify-center gap-5 py-3 flex-grow'>
                            {/* Using "flex-grow" to make this div take up remaining space */}
